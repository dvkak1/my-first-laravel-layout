...
<!--
    ...
    Think of this as your main layout file with an HTML navigation bar.
    ...
    For Tailwind layouts, go to: https://tailwindcss.com/docs/installation/play-cdn #
    and pick a free layout to get started for all intents and purposes of reviewing
    Laravel Blade component making.
...
<div class="min-h-full">
      ...
      <div class="flex h-16 items-center justify-between">
        <div class="flex items-center">
          ...
          <div class="hidden md:block">
            <div class="ml-10 flex items-baseline space-x-4">
              ...
              {{--
              <!--:active="request-()->is('contact')" is typed this way because it means that you are passing raw PHP data
              instead of a string. The colon before active means that you are passing raw PHP data.
              --}}
        ...
        <div class="hidden md:block">
          <div class="ml-4 flex items-center md:ml-6">
            @guest
             <x-nav-link href="/login" type="a" :active="request()->is('login')">Log In</x-nav-link>
             <x-nav-link href="/register" type="a" :active="request()->is('register')">Register</x-nav-link>
            @endguest

            @auth
                {{--
                 Generally, this is a bad coding practice. See code below for a more secure way of logging out.
      ...
      <div class="border-t border-white/10 pt-4 pb-3">
        <div class="flex items-center px-5">
          ...
          <div class="ml-3">
            ...
            <div class="text-sm font-medium text-gray-400">jeffreyway@laracasts.com</div>
          </div>
  ...
  <header class="relative bg-gray-800 after:pointer-events-none after:absolute after:inset-x-0 after:inset-y-0 after:border-y after:border-white/10">
    <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
      <h1 class="text-3xl font-bold tracking-tight text-white">{{ $heading }}</h1> <br>
